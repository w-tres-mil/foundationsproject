...
lag_1_2025 <- lag_1_2025%>%
  ...
  mutate(berlin = ifelse(vstate == 11,1,0))%>%# Create binary variable
...
write.csv(predictions_base,"/Users/tracemiller/Documents/bocconi courses/foundation/assignment group/predictions_lag1db.csv")
