...
x <- as.matrix(lag_1_train[,c(51:311,1:3)])
...
x_test <- as.matrix(lag_1_test[, c(51:311, 1:3)])
...
write.csv(predictions_base,"/Users/tracemiller/Documents/bocconi courses/foundation/assignment group/predictions_lag1.csv")
